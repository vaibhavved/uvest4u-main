...
export type slideConfig = {
  ...
  responsive: [
    {
      breakpoint: number; // Apply settings below 576px screen width
      settings: {
        slidesToShow: number;
      };
    }
...
export class HowWorksComponent {
   ...
   */
  slideConfigSig = signal<slideConfig>({
    slidesToShow: 3,
    slidesToScroll: 1,
    dots: true,
    infinite: false,
    ...
    this.metaService.addTags([
      {
        name: 'description',
        content:
          "Maximize returns with Uvest4U's AI Investment Strategies. Embrace the future of investing with our smart, data-driven solutions. Invest smarter today!"
      }
    ]);
