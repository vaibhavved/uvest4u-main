...
export class UserService {
  ...
  getPriceTechnicalsBySymbolAndDateRange(symbol: any, startDate: any, endDate: any): Observable<any> {
    return this.http.get(
      environment.apiBaseUrl + `/pricetechnicals/SymbolDateWithPrice/${symbol}/${startDate}/${endDate}`
    );
  }
  ...
  underConstruction() {
    return this.http.get(`/sysdata/CodeNAme/SITEMANAGEMENT/UNDERCONSTRUCT`);
  }
  ...
  captureDetails(body?: any) {
    return this.http.post(`/account/marketing`, body, {
